...
AC_REASON_EMBEDDINGS_ORCA_HAND_RECTIFIED_FLOW_2B_ONE_SAMPLE = LazyDict(
    dict(
        defaults=[
            DEFAULT_CHECKPOINT.experiment,
            {"override /model": "action_conditioned_video2world_fsdp_rectified_flow"},
...
for _item, _item_wo_resume, _item_mock_wo_resume in [
    ...
    [
        ...
        *build_debug_runs(AC_REASON_EMBEDDINGS_ORCA_HAND_RECTIFIED_FLOW_2B_ONE_SAMPLE),
    ],
    [
        AC_REASON_EMBEDDINGS_DROID_HAND_RECTIFIED_FLOW_2B_SIMPLE,
        *build_debug_runs(AC_REASON_EMBEDDINGS_DROID_HAND_RECTIFIED_FLOW_2B_SIMPLE),
    ],
    [
        AC_REASON_EMBEDDINGS_DROID_RECTIFIED_FLOW_2B_ONE_SAMPLE,
        *build_debug_runs(AC_REASON_EMBEDDINGS_DROID_RECTIFIED_FLOW_2B_ONE_SAMPLE),
    ]
]:
