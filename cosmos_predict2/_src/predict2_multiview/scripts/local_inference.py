...
PYTHONPATH=. torchrun --nproc_per_node=8 --master_port=12341 -m cosmos_predict2._src.predict2_multiview.scripts.local_inference --experiment ${EXP} --ckpt_path ${ckpt_path} --context_parallel_size 8 --input_is_train_data --use_apg --max_samples 10 --save_root results/apg
```
...
torchrun --nproc_per_node=8 --master_port=13345 -m cosmos_predict2._src.predict2_multiview.scripts.local_inference --experiment ${EXP} --ckpt_path ${ckpt_path} --context_parallel_size 8 --input_root ./benchmark_20250714/internal --max_samples 10 --save_root results_buttercup
```
...
torchrun --nproc_per_node=8 --master_port=13345 -m cosmos_predict2._src.predict2_multiview.scripts.local_inference --experiment ${EXP} --ckpt_path ${ckpt_path} --context_parallel_size 8 --input_root ./benchmark_20250714/internal --max_samples 1 --save_root results_buttercup_local
```
...
from cosmos_predict2._src.predict2_multiview.models.multiview_vid2vid_model import USE_APG_KEY
