...
"""Camera conditioned Video2World inference script."""
...
from cosmos_predict2.camera_conditioned_config import (
    ...
    CameraConditionedInferenceOverrides,
...
class Args(pydantic.BaseModel):
    ...
    setup: CameraConditionedSetupArguments
    """Setup arguments."""
    overrides: CameraConditionedInferenceOverrides
    """Inference parameter overrides."""


def main(args: Args) -> None:
    inference_args = CameraConditionedInferenceArguments.from_files(args.input_files, overrides=args.overrides)
    init_output_dir(args.setup.output_dir, profile=args.setup.profile)

    from cosmos_predict2.camera_conditioned import inference
